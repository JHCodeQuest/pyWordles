...
🚀 Getting Started
Prerequisites
1. Make sure you have Python 3.8+ installed. You will need two external libraries:Bashpip install requests colorama
2. InstallationClone this repository.Ensure you have a words.txt file in the root directory (one 5-letter word per line).Run the bot:Bashpython main.py
📊 Statistics & Logging
